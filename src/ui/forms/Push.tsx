    ...
    <form>
      <div className="space-y-12">
        <div className="border-b border-gray-900/10 pb-12">
          <div className="grid w-full grid-cols-12  rounded-lg bg-indigo-500/70">
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-12 sm:grid-cols-6">
            <div className="col-span-4 col-start-2">
              ...
              >
                Screenshot of achievements before pushes
              </label>
            ...
            <div className="col-span-4 col-start-2">
              ...
              >
                Screenshot after finishing all your missions
              </label>
